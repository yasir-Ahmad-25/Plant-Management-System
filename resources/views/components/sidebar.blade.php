...
<aside class="fixed left-0 top-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 bg-white border-r border-gray-200 shadow-lg">
    ...
    <nav class="p-4 space-y-2">
        ...
        <a href="{{ route('admin.sales')}}" 
           class="flex items-center px-4 py-3 text-sm font-medium text-gray-700 rounded-md hover:bg-green-100  hover:text-gray-900 transition-all duration-200 {{ request()->routeIs('admin.sales') ? 'bg-green-500 text-white shadow-lg' : 'text-gray-700 hover:bg-green-100 hover:text-gray-900' }}">
            <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20">
        ...
        <a href="{{ route('admin.settings') }}" 
           class="flex items-center px-4 py-3 text-sm font-medium text-gray-700 rounded-md hover:bg-green-100 hover:text-gray-900 transition-all duration-200 {{ request()->routeIs('admin.settings') ? 'bg-green-500 text-white shadow-lg' : 'text-gray-700 hover:bg-green-100 hover:text-gray-900' }}">
            <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20">
